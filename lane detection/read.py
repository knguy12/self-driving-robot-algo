...
#Finds the left and right lane by classifying the blue tape based on which side they are on the screen. Once classified, 
#calculate average of the slopes and intercepts of the line segments to get the slopes and intercepts of left and right lane lines. 
...
frame = cv2.imread('straight2.jpg')
lane_line_coordinates = detectLane(frame)
lane_line_image = display_lines(frame, lane_line_coordinates)

imS = cv2.resize(lane_line_image, (960, 540))      
